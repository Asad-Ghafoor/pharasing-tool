    ...
    tableColumns[index] = {
      ...
      render: (_, record) => (
        <div>
          <button
            className="btn"
            onClick={() => HandleAction({ record, type: "edit" })}
          >
            <FaEdit style={{ color: "skyblue" }} size={20} />
          </button>
          &nbsp;
          <button
            className="btn redGradientBtn"
    ...
    <div className="custom-table">
      <Row align="middle" justify="start">
        <Col
          ...
          md={24}
          lg={24}
          xl={descreaseRightActionWidth ? 12 : 8}
        >
          <Row align="middle">
            {tableLeftActions?.map((el, i) => (
              <Col key={i} className="custome-table-left-action">
                <Link
                  to="#"
                  onClick={() => tableLeftActionsHandler(el)}
                  {...(el === tableLeftActiveAction
                    ? {
                        className: "theme-btn btn-pad table-left-active-action",
                      }
                    : {})}
                >
                  {el}
        ...
        <Col
          ...
          md={24}
          lg={24}
          xl={descreaseRightActionWidth ? 12 : 16}
        >
